...
const interviewReportSchema = z.object({
    technicalQuestions: z.array(z.object({
        question: z.string().describe("The technical question to be asked"),
        intention: z.string().describe("The interviewer's underlying intention"),
        answer: z.string().describe("The ideal answer"),
        followUpQuestions: z.array(z.string()),
        explanation: z.string().describe("Why this question matters"),
        strengths: z.array(z.string().describe("Candidate's advantages for this question based on resume")),
        weaknesses: z.array(z.string().describe("Candidate's blind spots for this question")),
